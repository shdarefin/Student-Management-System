...
if($connection==false){
    ...
    $myquery="INSERT INTO student_details(stu_id,stu_f_name,stu_l_name,stu_contract,stu_another_contract,current_semester,gender,birth_date) VALUES('$stu_id','$stu_f_name','$stu_l_name','$stu_contract','$stu_another_contract','$current_semester','$gender','$birth_date')";
